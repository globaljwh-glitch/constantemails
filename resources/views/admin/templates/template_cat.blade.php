...
@section('title', 'Template Categories | Constant Emails')
        ...
        <div class="col-lg-12 col-12">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    <form id="categoryForm" action="{{ route('template-categories.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-7 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="categoryName" name="name"
                                        ...
                                        placeholder="e.g. E-commerce Newsletters" value="{{ old('name') }}" required>
                                </div>
                ...
                <div class="widget-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-12 col-12 d-flex justify-content-end mt-sm-0 mt-3">
                            <form action="{{ route('template-categories.index') }}" method="GET"
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        @if(request('search'))
                                            <a href="{{ route('template-categories.index') }}" class="btn btn-danger"
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped mb-4">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-center">
                                            <ul class="table-controls mb-0">
                                                <!-- 1. VIEW TEMPLATES BUTTON -->
                                                <!-- Notice the route parameter 'category_id' being passed here -->
                                                <li>
                                                    <a href="{{ route('templates.index', ['category_id' => $category->id]) }}"
                                                        data-toggle="tooltip" data-placement="top" title="View Templates">
                                                        <i class="flaticon-menu-list fs-20 text-success"></i>
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <form action="{{ route('template-categories.destroy', $category->id) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-4 text-muted">No categories found. Create one
                                            above!</td>
                                    </tr>
                                @endforelse
                            </tbody>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.btn-edit-category', function () {
                ...
                let updateBaseUrl = "{{ url('admin/template-categories') }}";
            ...
            $('#cancelEditBtn').on('click', function () {
                ...
                $('#categoryForm').attr('action', "{{ route('template-categories.store') }}");
