...
@section('title', 'Manage CMS Articles | Constant Emails')
                ...
                <div class="widget-header">
                    <div class="row align-items-center">
                        ...
                        <div
                            ...
                            <form action="{{ route('cms-articles.index') }}" method="GET" class="mr-3"
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        @if(request('search')) <a href="{{ route('cms-articles.index') }}"
                                        class="btn btn-danger">Clear</a> @endif
                                    </div>
                                </div>
                            </form>
                            <a href="{{ route('cms-articles.create') }}" class="btn btn-gradient-warning btn-rounded"
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped mb-4">
                            ...
                            <tbody>
                                @forelse($articles as $key => $art)
                                    <tr>
                                        <td class="align-center">
                                            {{ ($articles->currentPage() - 1) * $articles->perPage() + $key + 1 }}
                                        </td>
                                        <td><span class="article-name">{{ $art->title }}</span></td>
                                        ...
                                        <td class="align-center">
                                            <ul class="table-controls mb-0">
                                                <li><a href="{{ route('cms-articles.edit', $art->id) }}" data-toggle="tooltip"
                                                        title="Edit"><i class="flaticon-edit-fill-2 fs-20"></i></a></li>
                                                <li>
                                                    <form action="{{ route('cms-articles.destroy', $art->id) }}" method="POST"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-4">No CMS articles found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
